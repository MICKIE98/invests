!function() {
    ...
    r.prototype.rectToPath = function(t) {
        ...
        if (t.rx || t.ry) {
            ...
            e.d = "M" + r + " " + n + " L" + (r + i) + " " + n + " L" + (r + i) + " " + (n + a) + " L" + r + " " + (n + a) + " Z";
        return e
    }
    ,
    ...
    i.prototype.renderPath = function(t) {
        if (this.forceRender && this.map && this.map[t]) {
            var e = this.map[t]
              , r = e.el.cloneNode(!0);
            e.el.parentNode.replaceChild(r, e.el),
            e.el = r
        }
    }
    ,
